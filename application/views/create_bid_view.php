		...
		<table class="table table-striped">
			...
			<tbody>
				<?php foreach($bid_inventory->result() as $row){ ?>
					<tr>
						<form class="form" action="<?php echo site_url();?>/listing/create_bid" method="POST">
							<td>
							...
							<td class="span9">
								<textarea rows="1" class="span6" name="message" placeholder="Persuasion goes here..."></textarea>
							</td>
							<td>
								<button type="submit" class="btn btn-primary"><i class="icon-flag"></i> Make Bid</button>
							</td>
						</form>
					</tr>
				<?php } ?>
